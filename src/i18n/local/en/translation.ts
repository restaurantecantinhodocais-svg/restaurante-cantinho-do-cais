const translation = {
  ...
  menu_cat_fish_desc: "Fish Stew, Octopus, Blackbelly Rosefish, Forkbeard, Alfonsino and more, from the grill or in elaborate dishes.",
  ...
  footer_developed_by: "Developed by Ponto Zero Apps",
