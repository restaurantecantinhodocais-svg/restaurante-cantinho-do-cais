const translation = {
  ...
  about_p4: "Als Spezialisten für Fisch und regionale Küche ehren wir die azoreanische Gastronomie mit unserer berühmten Fischsuppe, dem traditionellen Fischeintopf und Spezialitäten aus den Gewässern unserer Küste — darunter GeiBbrasse, Schwarzer Rotbarsch, Gabelborsch, KaiserBarsch, Thunfisch, Oktopus, sowie andere täglich frisch ausgewählte Fisch- und Meeresfrüchte. Ob frisch gegrillte Fischgerichte oder aufwendigere Rezepte der azoreanischen Küche — jedes Gericht feiert den authentischen Geschmack der Insel. Zwischen traditionellen Geheimnissen und hausgemachten Desserts öffnen wir unsere Türen, damit sich jeder Gast wirklich wie zu Hause fühlt.",
  ...
  menu_cat_fish_desc: "Fischeintopf, Oktopus, Schwarzer Rotbarsch, Gabelborsch, KaiserBarsch und mehr, vom Grill oder in aufwendigen Gerichten.",
